...
#define FAN_KICKSTART_TIME 100 //kp3s
 ...
 */
#define E0_AUTO_FAN_PIN PB0 // kp3s
 ...
 */
#define XY_FREQUENCY_LIMIT      15 // kp3s (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // kp3s
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define SHOW_REMAINING_TIME       // Display estimated time to completion
    ...
    #define USE_M73_REMAINING_TIME  // Use remaining time from M73 command instead of estimation KP3S
    #define ROTATE_PROGRESS_DISPLAY // Display (P)rogress, (E)lapsed, and (R)emaining time KP3S
  #endif
    ...
    #define LCD_PROGRESS_BAR            // kp3s Show a progress bar on HD44780 LCDs for SD printing
  ...
  #define SD_DETECT_STATE LOW // kp3s
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY // kp3s
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // kp3s Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
  ...
  #define LONG_FILENAME_HOST_SUPPORT // kp3s

  // Enable this option to scroll long filenames in the SD card menu
  #define SCROLL_LONG_FILENAMES //kp3s
   ...
   */
  #define AUTO_REPORT_SD_STATUS // kp3s
  ...
  #define BINARY_FILE_TRANSFER //kp3s
 ...
 */
#define ADVANCED_PAUSE_FEATURE // kp3s
  ...
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      12  // (mm/s) feedrate to purge before unload
